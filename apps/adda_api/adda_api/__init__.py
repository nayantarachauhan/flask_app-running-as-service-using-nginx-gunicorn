...
# import config
# from config import *
# from automating_claims.config import *
...
def create_app():
	...
	with app.app_context():
		...
		# from adda_api.views.adminview.customadminview import AdminIndex
		# admin = Admin(app, base_template='my_master.html', index_view=AdminIndex(),template_mode = 'bootstrap3')
		
		jwt.init_app(app)
		login_manager.init_app(app)

		from adda_api.routes import api_bp
		app.register_blueprint(api_bp, url_prefix='')

		# from adda_api.views.adminview import addAdminView,addContextProcessor
		# addAdminView(admin)
